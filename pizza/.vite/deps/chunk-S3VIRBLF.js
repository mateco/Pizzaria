...
function createCssVarsProvider(options) {
  ...
  true ? CssVarsProvider.propTypes = {
     ...
     */
    forceThemeRerender: import_prop_types10.default.bool,
    /**
...
function createGrid(options = {}) {
  const {
    ...
    useTheme: useTheme2 = useTheme_default,
  ...
  const Grid2 = React25.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime10.jsx)(GridRoot, {
      ...
      children: React25.Children.map(children, (child) => {
        var _a;
        if (React25.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-S3VIRBLF.js.map
